...
export default function LandingCoreArgument() {
  return (
      <section className="mx-auto max-w-5xl px-4 py-16 sm:py-24 md:py-40 text-center md:px-8 overflow-hidden">
        <motion.div
        ...
        >
          <h2 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold leading-snug sm:leading-tight text-slate-900 dark:text-white break-words">
          ...
          <p className="mt-6 sm:mt-8 text-base sm:text-xl md:text-2xl font-medium text-slate-600 dark:text-white/70">
            The difference in energy efficiency is measurable — <br className="hidden md:block"/>and this tool measures it.
          </p>
          <p className="mt-6 sm:mt-8 text-sm sm:text-lg md:text-2xl font-medium text-slate-600 dark:text-white/70 leading-relaxed">
